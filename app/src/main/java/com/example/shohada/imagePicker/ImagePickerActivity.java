package com.example.shohada.imagePicker;
...
public class ImagePickerActivity extends AppCompatActivity {
            ...
            switch (which) {
                case 0:
                    if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
                        ...
                        Toast.makeText(context, "گوشی شما این قابلیت را اجرا نمیکند", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 1:
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        Uri ss = getUriForFile(ImagePickerActivity.this, getPackageName() + ".provider", image);
        return ss;
    }
